...
if __name__ == '__main__':
    ...
    parser.add_argument('--source2target', type=str, default='one2many', help='Setting of source-target pair')
    ...
    result_file = 'result/one2many/PMAES-{}.txt'.format(seed)
